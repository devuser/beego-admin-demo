...
func (t *DPSCkzh) TableName() string {
	return beego.AppConfig.String("base_dps_ckzh_table")
}

func init() {
	orm.RegisterModel(new(DPSCkzh))
}

// AddDPSCkzh insert a new DPSCkzh into database and returns
// last inserted Id on success.
func AddDPSCkzh(m *DPSCkzh) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}

// GetDPSCkzhById retrieves DPSCkzh by Id. Returns error if
// Id doesn't exist
func GetDPSCkzhById(id int64) (v *DPSCkzh, err error) {
	o := orm.NewOrm()
	v = &DPSCkzh{Id: id}
...
func GetDPSCkzhList(page int64, page_size int64, sort string) (nodes []orm.Params, count int64) {
	o := orm.NewOrm()
	node := new(DPSCkzh)
...
// GetAllDPSCkzh retrieves all DPSCkzh matches certain condition. Returns empty list if
// no records exist
func GetAllDPSCkzhs(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(DPSCkzh))
	// query k=v
	for k, v := range query {
...
// UpdateDPSCkzh updates DPSCkzh by Id and returns error if
...
// DeleteDPSCkzh deletes DPSCkzh by Id and returns error if
// the record to be deleted doesn't exist
func DelDPSCkzhById(id int64) (err error) {
	o := orm.NewOrm()
	v := DPSCkzh{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&DPSCkzh{Id: id}); err == nil {
