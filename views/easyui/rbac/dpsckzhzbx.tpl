...
$(function(){
    ...
    $("#datagrid").datagrid({
        ...
        columns:[[
            ...
            {field:'ZhangHao',title:'ZhangHao',width:50,sortable:true},
            {field:'Jiaoyije',title:'Jiaoyije',width:100,sortable:true},
            {field:'Jiaoyirq',title:'Jiaoyirq',width:100,align:'center',editor:'text'},
            {field:'Guishjig',title:'Guishjig',width:50,sortable:true},
            {field:'Chjianjg',title:'Chjianjg',width:50,sortable:true},
...
<div id="dialog" title="添加存款账户指标项" style="width:400px;height:400px;">
