...
$(function(){
    ...
    $("#datagrid").datagrid({
        ...
        columns:[[
            ...
            {field:'SrcHuobdaih',title:'SrcHuobdaih',width:100,align:'center',editor:'text'},
            {field:'DstHuobdaih',title:'DstHuobdaih',width:100,align:'center',editor:'text'},
            {field:'StartAt',title:'StartAt',width:100,align:'center',
                formatter:function(value,row,index){
                    if(value) return phpjs.date("Y-m-d",phpjs.strtotime(value));
                    return value;
                }
            },
            {field:'OverAt',title:'OverAt',width:100,align:'center',
                formatter:function(value,row,index){
                    if(value) return phpjs.date("Y-m-d",phpjs.strtotime(value));
                    return value;
                }
            },
            {field:'ExchangeRate',title:'ExchangeRate',width:100,align:'center',editor:'text'},
